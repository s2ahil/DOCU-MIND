  ...
  return (
    <div id="pricing" className="flex flex-col items-center gap-y-4 p-8 mb-10">
      ...
      <div className="text-center">
        ...
        Docu-Mind is free for 100 customer , paid feature is coming soon...
        </p>
      </div>
      <div className="flex flex-wrap w-full justify-center mt-16 gap-y-10">
        <div className="card border border-gray-400 order-3 lg:order-1">
          <div className="card-body gap-y-3">
            ...
            <Link href="/chat-with-docs" className="group btn btn-block relative h-[calc(48px+8px)] rounded-full bg-primary py-1 pl-6 pr-14 text-neutral-50 hover:border-none hover:bg-transparent">
            ...
            <ul className="flex flex-col gap-y-4 text-base">
              <li className="flex gap-2 items-center">
                ...
                <span>Store only 1 pdf at a time</span>
              </li>
              <li className="flex gap-2 items-center">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
              ...
              <li className="flex gap-2 items-center">
                ...
                <span>unlimited usage for first 100 customers</span>
              </li>
              <li className="flex gap-2 items-center">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
